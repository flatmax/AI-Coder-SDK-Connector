...
**Status:** Phases 0–4 and 6 done or substantially done; phase 5 has not started. The consultant
ships and streams into its own tab, the engine router is wired into startup, and Antigravity can be
chosen as master — though no live turn has been driven through it as master yet. This directory is

...
| `mcp-integration.md` | [`../3-engine/mcp-bridge.md`](../3-engine/mcp-bridge.md) | Inverted, and shipped. The speculative design had AIC⚡DC *consuming* MCP servers; the conversion makes AIC⚡DC *be* one, and third-party servers arrive through project settings without our involvement. See [decisions § CC-6](../plan/decisions.md#cc-6--the-indexes-reach-claude-code-as-mcp-tools-not-as-prompt-text). |

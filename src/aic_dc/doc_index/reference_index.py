...
Mirrors :class:`aic_dc.symbol_index.reference_index.ReferenceIndex`
...
if TYPE_CHECKING:
    from aic_dc.doc_index.models import DocHeading, DocLink, DocOutline
...
class DocReferenceIndex:
    ...
    def connected_components(self) -> list[set[str]]:
        ...
        (:meth:`aic_dc.symbol_index.reference_index.ReferenceIndex.connected_components`)
